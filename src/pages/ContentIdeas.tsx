...
export const ContentIdeas = () => {
  ...
  return (
    <Layout>
      ...
      <div className="relative min-h-[calc(100vh-2rem)] -m-4 sm:-m-6 lg:-m-8 -ml-64 mb-0 bg-gradient-to-br from-primary-light via-background to-accent/20 overflow-hidden">
